...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "3926245db05ce40c095af7e1afbe47ea21f277ff";
const resourcesToCache = ["https://raw.githubusercontent.com/maxence-charriere/go-app/master/docs/web/icon.png","/web/style.css","/web/app.wasm","/wasm_exec.js","/manifest.webmanifest","/app.js","/app.css","/"];

self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker 3926245db05ce40c095af7e1afbe47ea21f277ff");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker 3926245db05ce40c095af7e1afbe47ea21f277ff is activated");
  } catch (error) {
