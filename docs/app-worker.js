...
// PWA
// -----------------------------------------------------------------------------
const cacheName = "app-" + "d96440a90f7bd539cee2636ef24b913ee0f5929e";
...
self.addEventListener("install", async (event) => {
  try {
    console.log("installing app worker d96440a90f7bd539cee2636ef24b913ee0f5929e");
    await installWorker();
...
self.addEventListener("activate", async (event) => {
  try {
    ...
    console.log("app worker d96440a90f7bd539cee2636ef24b913ee0f5929e is activated");
  } catch (error) {
